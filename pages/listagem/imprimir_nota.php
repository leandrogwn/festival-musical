                ...
                <table class="table table-striped" style="font-size:12px!important;">
                    ...
                    <tbody>
                        ...
                        foreach ($conInscrito as $item) {
							...
							$consultaNota = "select afinacao, ritmo, interpretacao, letra, nota, id_jurado, id_interprete, nome
							from f_nota as fn
							inner join
							f_jurado as fj
							on
							fn.id_jurado = fj.id
							WHERE id_interprete = $item->id and fase = $fase";
							...
							foreach($conNotas as $itemNota){
								...
								echo  '<td colspan="10">Jurado(a): '.$itemNota->nome .'</td>';
                                echo '</tr>';
                               
                                echo '<tr>';
                                echo '<td colspan="1"></td>';
                                echo '<td style="text-align:center" colspan="1">Afinação<br>'. number_format($itemNota->afinacao, 3, '.', ''). '</td>';
                                echo '<td style="text-align:center" colspan="1">Ritmo<br>'. number_format($itemNota->ritmo, 3, '.', ''). '</td>';
                                echo '<td style="text-align:center" colspan="1">Interpretação<br>'. number_format($itemNota->interpretacao, 3, '.', ''). '</td>';
                                echo '<td style="text-align:center" colspan="1">Letra<br>'. number_format($itemNota->letra, 3, '.', ''). '</td>';
                            ...
                            echo '<tr>';
                            echo '<td colspan="1"></td>';
                            echo  '<td colspan="10">Média - ' .$info .'</td>';
                            echo '</tr>';
                            echo '<tr>';
                            echo '<td colspan="1"></td>';
