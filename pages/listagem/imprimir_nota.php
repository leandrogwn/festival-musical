...
ORDER BY $regra DESC, nota_afinacao DESC, nota_interpretacao DESC, nota_ritmo DESC
                    ...
                    <table class="table table-striped" style="font-size:12px!important;">
                        ...
                        <tbody>
                            ...
                            foreach ($conInscrito as $item) {
                                ...
                                $consultaNota = "select afinacao, ritmo, interpretacao, nota, id_jurado, id_interprete, nome
							from f_nota as fn
							inner join
							f_jurado as fj
							on
