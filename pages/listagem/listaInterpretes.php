                    ...
                    <tbody>
                        ...
                        foreach ($conInscrito as $item) {
                            ...
                            if ($qtdReg == 0) {
                                ...
                                echo '<a href="../../jurado/verificacaoNotas.php?festival=' . $idFestival . '&interprete=' . $item->id . '&fase=' . $fase . '&categoria=' . $nome_categoria . '&tela=lista_interprete_verificar_notas" target="_blank" class="btn btn-secondary" id="botao-listar-interprete" title="Acompanhar votação em tempo real" target="_top"><i class="bi bi-eye"></i></a> &nbsp;';
