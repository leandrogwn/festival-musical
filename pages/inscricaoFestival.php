        ...
        <form action="cadastro/inscricaoFestival.php" method="post" style="width: 70%;" name="form">
            ...
            ?>">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span4">
                                <label>RG</label>
                                <input type="text" id="rg" name="rg" style="width: 99%;" >
                            </div>
                            <div class="span4">
                                <label>CPF</label>
                ...
                <div class="row-fluid">
                    ...
                    <div class="span4">
                        <label>Celular</label>
                        <input type="text" id="celular" name="celular" onkeyup="mascara(this, mtel);" maxlength="15" style="width: 99%;" >
                    </div>
                    <div class="span4">
                        <label>E-mail</label>
                        <input type="email" id="email" name="email" style="width: 99%;" >
                    </div>
                </div>
                ...
                <div class="row-fluid">
                    <div class="span2">
                        <label>Cep</label>
                        <input type="text" id="cep" name="cep" style="width: 98%;" >
                    </div>
                    <div class="span1">
                        <label>UF</label>
                        <input name="uf" type="text" id="uf" style="width: 88%"/>
                    </div>
                    <div class="span7">
                        <label>Endereço</label>
                        <input name="rua" type="text" id="rua" style="width: 98%"/>
                    </div>
                    <div class="span2">
                        <label>Número</label>
                        <input name="numero" type="text" id="numero" style="width: 94%"/>
                    </div>
                </div>
                <div class="row-fluid">
                    <div class="span6">
                    ...
                    <div class="span6">
                        <label>Cidade</label>
                        <input name="cidade" type="text" id="cidade" style="width: 98%"/>
                    </div>
                </div>
            ...
            <fieldset>
                ...
                <div class="row-fluid">
                    ...
                    <div class="span3">
                        <label>Canção</label>
                        <input name="cancao" type="text" id="cancao" style="width: 98%"/>
                    </div>
                    <div class="span3">
                        <label>Compositor</label>
                        <input name="compositor" type="text" id="compositor" style="width: 98%"/>
                    </div>
                    <div class="span3">
                        <label>Gravado por</label>
                        <input name="gravado_por" type="text" id="gravado_por" style="width: 95%"/>
                    </div>
                </div>
                <div class="row-fluid">
                    <div class="span6">
                        <label>Link de vídeo ou audio com prévia de sua apresentação</label>
                        <input name="link" type="text" id="link" style="width: 98%"/>
                    </div>
                    <div class="span6">
                ...
                <textarea  class="textarea" rows="6" style="width: 99%;" name="letra" rows="5" cols="500"></textarea>
                <input type="hidden" id="tela" name="tela" value="inscricao_festival">
            </fieldset>
