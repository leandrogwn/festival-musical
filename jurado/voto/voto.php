...
<div class="container-index" id="container" style="width: 100%;">
    ...
    <script>
        function mediaNota() {
            ...
            campoNota.value = ((Number(notaAfinacao.value.replace(",", ".")) + Number(notaRitmo.value.replace(",", ".")) + Number(notaApresentacao.value.replace(",", "."))) / 3).toFixed(3);
        }
        ...
        function sweetalert() {
            ...
            Swal.fire({
                title: 'Atenção!',
                html: "Confirma as notas para o interprete <?php echo $item->nome ?>?<br><br>Afinação: <b>" + afn + "</b><br>Ritmo: <b>" + rit + "</b><br> Iterpretação: <b>" + interp + "</b><br> <br>Nota final: <b>" + nota + "</b><br>",
                icon: 'warning',
